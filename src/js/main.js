...
const arrayProyectos = [
  {nombre: "Academia Fenix",
   ...
   descripcion: " Academia que brinda cursos en diversas areas",
   tecnologia1: "#Wordpress",
   tecnologia2: "#Elementor",
   tecnologia3: "Edicion de plantillas",
   portada: "./src/img/iniciofenix.png" 
   },
   {nombre: "Portfolio Web",
   link: "https://www.behance.net/gallery/181643897/Antiguo-protfolio-web",
   descripcion: "proyecto final para el curso de Desarrollo Web en Coderhouse",
   tecnologia1: "#HTML",
   ...
   descripcion: "proyecto de un colegio para niños, web informativa",
   tecnologia1: "#Wordpress",
   tecnologia2: "#Elementor",
   tecnologia3: "Edicion de plantillas",
   ...
   descripcion: "proyecto de un jardin para niños, web informativa",
   tecnologia1: "#Wordpress",
   tecnologia2: "#Elementor",
   tecnologia3: "Edicion de plantillas",
